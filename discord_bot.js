...
var commands = {
	...
	"server": {
        description: "Give you the link to M8triX devs server!",
        process: function(bot, msg, suffix) {
            msg.channel.sendMessage( msg.author+" COMING SOON");
            if(suffix){
                msg.channel.sendMessage( "If not joinable maybe you're blocked or theres just maintenance!");
            }
        }
	},
    "myid": {
